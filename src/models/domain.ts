...
export const DOMAIN_STATUS_DESCRIPTIONS: Record<DomainStatus, string> = {
    ...
    [DomainStatus.deleting]: 'The domain is on its way out—currently being deleted and soon heading back into the wild.',
    [DomainStatus.disallowed]: 'This domain is off-limits by rules or policy, so it can’t be registered by anyone.',
    [DomainStatus.dpml]: 'Locked down by the DPML program, this domain is shielded to protect trademarks from squatters.',
    [DomainStatus.expiring]: 'The timer is ticking—this domain’s registration is almost up, and it may soon be up for grabs.',
    ...
    [DomainStatus.parked]: 'The domain has an owner but is just sitting there, usually pointing to ads or placeholders.',
    ...
    [DomainStatus.suffix]: 'This is a known domain ending (like .io or .dev) rather than a name you can register directly.',
    ...
    [DomainStatus.unknown]: 'No one’s quite sure what’s going on with this domain—it’s in the mystery box.',

export default function AboutPage() {
    return (
        <div className="min-h-screen">
            <main className="m-auto flex w-full max-w-4xl flex-col gap-3 p-10 md:gap-5">
                <h2 className="text-lg font-medium md:text-xl">What's a domain hack</h2>
                <p className="md:text-md font-sans text-sm font-light">
                ...
                <p className="md:text-md font-sans text-sm font-light">
                    ...
                    ".me" to creatively spell out brand names or phrases. Popular examples include{' '}
                ...
                <h2 className="text-lg font-medium md:text-xl">Why domain hacks are so effective</h2>
                <p className="md:text-md font-sans text-sm font-light">
                    Well-crafted domain hacks do more than showcase creativity—they make your site more memorable and
                    shareable.
                </p>
                <p className="md:text-md font-sans text-sm font-light">
                    In a sea of standard ".com" addresses, a domain hack can help your website
                    <span className="font-bold">💡 stand out</span>,
                    <span className="font-bold">🕶️ pique curiosity</span>, and convey a more
                ...
                <h2 className="text-lg font-medium md:text-xl">Build Your Brand Around It</h2>
                <p className="md:text-md font-sans text-sm font-light">
